...
// icon                       label
 { 
  ...
  {ICON_Y_DEC,                LABEL_YAXIS_UP},
  {ICON_Z_INC,                LABEL_Z_INC},
  {ICON_1_MM,                 LABEL_1_MM},
  {ICON_X_DEC,                LABEL_X_DEC},
  {ICON_Y_INC,                LABEL_YAXIS_DOWN},
...
const  float item_move_len[ITEM_MOVE_LEN_NUM] = {0.12f, 1, 10};
...
void menuMove(void)
{
  ...
  while(infoMenu.menu[infoMenu.cur] == menuMove)
  {
    ...
    switch(key_num)
    {
      ...
      case KEY_ICON_5: storeCmd(YGCODE_UP,   item_move_len[item_move_len_i]);    break;
      ...
      case KEY_ICON_1: storeCmd(YGCODE_DOWN, item_move_len[item_move_len_i]);    break;
