...
void menuManualLeveling(void)
{
  ...
  while(infoMenu.menu[infoMenu.cur] == menuManualLeveling)
  {
    ...
    switch(key_num)
    {
      ...
      case KEY_ICON_5: infoMenu.menu[infoMenu.cur] = menuBabyStep; break;
      case KEY_ICON_6: infoMenu.menu[infoMenu.cur] = menuMove; break;
      case KEY_ICON_7:
        infoMenu.cur--; break;
      default:break;
    }
